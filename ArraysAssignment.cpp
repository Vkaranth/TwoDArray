...
int main() {
	...
	if(manualEntryChoice == 'y' || manualEntryChoice == 'yes'){
		...
		doubleArray.setDoubleValues();
	}

	doubleArray.displayValues();
	...
	case 1:
		...
		cout << "The first matrix is:\n";
				...
				if(enterAnotherMatrix == 'yes' || enterAnotherMatrix == 'y'){
					...
					cout << "Enter array entries\n";
					doubleArrayThree.getValues();
					doubleArrayThree.displayValues();
...
//		++stringSum;
		...
		stringArray++;
		cout << "-----------------------------------------------------------" << endl;
		stringArray.setIncrementedValue();
//		cout << "--------------------------------------------------------------" << endl;
//		stringArray.m_displayValues();
		...
		if(enterAnotherMatrix == 'yes' || enterAnotherMatrix == 'y'){
			...
			stringArrayTwo.getStringValues();
			cout << "You entered\n";
			stringArrayTwo.displayValues();
...
//			stringSum.m_displayValues();
			...
			Array2D<string> stringArrayTwo = stringArray;
			stringArrayTwo.setStringValues();
			cout << "First matrix\n";
			stringArrayTwo.displayValues();
			cout << "Second matrix\n";
			stringArray.displayValues();
